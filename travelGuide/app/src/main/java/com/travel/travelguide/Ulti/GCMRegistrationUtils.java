...
public class GCMRegistrationUtils extends Handler {
    ...
    private static final String GCM_SENDER_ID = "646175691627";
        ...
        if (msg.what == 1) {
            ...
            PushNotificationTask.TaskListener listener = new PushNotificationTask.TaskListener() {
                ...
                public void onSuccess(RegistrationResponse registrationResponse) {
                    LogUtils.logD(GCMRegistrationUtils.class.getSimpleName(), "PushNotificationTask success: " + registrationResponse.toString());
                }

                @Override
                public void onFailure(RegistrationResponse registrationResponse, Exception exception) {
                    LogUtils.logE(GCMRegistrationUtils.class.getSimpleName(), "PushNotificationTask onFailure: " + registrationResponse.toString());
                }
            };
